            ...
            <div class="card">                     
                <div class="card-header">                         
                    <div class="float-left">                             
                        <span class="cardtitle"><h3>Lihat Detail Pegawai</h3></span>                         
                    </div>                         
                ...
                <table class="table table-sm">            
                    <tr>
                        <td style="width: 200px;"><strong>Nomor Induk Pegawai (NIP)</strong></td>                
                        <td>: {{ $pegawai->id }}</td> 
                    </tr>                           
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>: {{ $pegawai->getAgama() }}</td>
                    </tr>            
                    <tr>
                        <td><strong>Jenis Kelamin </strong></td>                
                        <td>: {{ $pegawai->jenis_kel=="L" ?  "Laki-laki" : "Perempuan"}}</td>
                    </tr>            
                    <tr>
                        <td><strong>Jabatan </strong></td>                
                        <td>: {{ \App\Models\MstJabatan::find ( $pegawai->mst_jabatan_id)->nama_jabatan }}</td>
                    </tr>                      
                    <tr>
