<div class="box box-info padding-1">  
    <div class="box-body"> 
        ...
        <div class="form-group">  
            ...
            {!! $errors->first('no_sk_pangkat','<div class="invalid-feedback">:message</p>') !!}    
    
            <div class="form-group">  
                {{ Form::label('Tanggal Terhitung Mulai') }}  
                {{ Form::date('tanggal_tmt_pangkat', $rw->tanggal_tmt_pangkat,['class' => 'formcontrol' .     
                    ($errors->has('tanggal_tmt_pangkat') ? ' is-invalid' : ''), 'placeholder' => '']) }}  
                {!! $errors->first('tanggal_tmt_pangkat','<div class="invalidfeedback">:message</p>') !!}  
            </div>  
        </div>    
        <div class="form-group">  
            {{ Form::label('pangkat_golongan') }}   
            {{ Form::select('mst_pangkat_id',$pangkat, $rw->mst_pangkat_id ,['id'=>'mst_pangkat_id','class' => 'form-control' .             
                ($errors->has('mat_pangkat_id') ? ' is-invalid' : ''), 'placeholder' => '--- pilih ---']) }}             
        ...
        <div class="form-group">    
            {{ Form::label('Status') }}    
            {{ Form::select('status',\App\Models\RiwayatPangkat::listStatus(), $rw->status, ['id'=>'status','class' => 'form-control' .           
