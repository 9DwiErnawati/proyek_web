                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;"> 
                            ...
                            <div class="float-right">                              
                                <div class="input-group custom-search-form">                               
                                    <a href="{{ url('riwayat-pangkat/create')."/".$peg->id }}" class="btn btn-primary btn-sm">                                
                                ...
                                <tbody>                                     
                                    ...
                                    @foreach ($rw as $peg)                                         
                                        <tr>                                             
                                            ...
                                            <td>{{ $peg->getPangkat->nama_pangkat == null ? "Belum punya" :                                                   
                                                    $peg->getPangkat->nama_pangkat}} </td>                                             
                                            <td>{{ $peg->getPangkat->pangkat_gol }}</td>                                             
                                            <td>{{ $peg->gaji_pokok}}</td>                                             
                                            <td>{{ $peg->status==0 ?"Tidak":"Berlaku"}}</td>                                             
                                            </td>                                             
                                            <td>                                           
                                            <form action="{{ route('riwayatpangkat.destroy', $peg->id) }}"                                             
                                                    method="POST" >                                             
                                                <a class="btn btn-sm btn-primary" href="{{ route('riwayatpangkat.show',$peg->id) }}" >                                               
                                                    <i class="fa fa-fw fa-eye"></i> Lihat</a>                                             
                                                <a class="btn btn-sm btn-success" href="{{ route('riwayatpangkat.edit',$peg->id) }}" >                                               
